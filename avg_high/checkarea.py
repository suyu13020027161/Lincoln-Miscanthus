...
def read_and_print_ply(pointnum, filepath, polygons, out_path):
    ...
    with open(filepath, 'r') as file:
        ...
        modified_lines = lines[:header_end_index]               
        ...
        for line in lines[header_end_index:]:
            ...
            #print(f'X: {x}, Y: {y}, Z: {z}')        
            red, green, blue = parts[6], parts[7], parts[8]
...
out_path = "/home/ysu/Miscanthus/avg_high/Miscanthus_out.ply"
...
avgh0, avgh1, avgh2, avgh3, avgh4, avgh5, avgh6 = read_and_print_ply(pointnum, file_path, polygons, out_path)
